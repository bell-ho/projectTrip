...
<script>
    ...
    $(document).ready(function () {
        ...
        var showReply = function () {
            $.ajax({
                url: "/reply/" +${board.board_no}, success: function (reply) {
            ...
            $(document).on("click", "#update", function (e) {
                ...
                $.ajax({
                    url: "../reply/${board.board_no}/" + reply_no, success: function (reply) {
                        console.log(reply);
            ...
            <div class="panel panel-default" id="main">
                <div class="panel-body">
                    ...
                    <label>작성자 : <c:out value="${board.mem_nickname}"/>
                        <label>조회수 : <c:out value="${board.board_hit}"/></label>
                    </label>
                    <label style="float: right;">작성일 : <fmt:formatDate pattern="yyyy-MM-dd"
                                                                       value="${board.board_regdate }"/></label> <br>
                    <hr>
